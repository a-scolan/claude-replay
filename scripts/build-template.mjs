...
const PLACEHOLDERS = [
  ...
  { pattern: '"/*DEFAULT_THEME_MODE*/"', token: '"__PLACEHOLDER_DEFAULT_THEME_MODE__"' },
  { pattern: "/*DEFAULT_AUTOPLAY*/false", token: "__PLACEHOLDER_DEFAULT_AUTOPLAY__" },
  { pattern: "/*DEFAULT_EXPAND_TOOLS*/false", token: "__PLACEHOLDER_DEFAULT_EXPAND_TOOLS__" },
  { pattern: "/*DEFAULT_UNGROUP_TOOLS*/false", token: "__PLACEHOLDER_DEFAULT_UNGROUP_TOOLS__" },
